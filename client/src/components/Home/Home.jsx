...
import { getMovies, getUserMovies } from '../../redux/actions';
...
function Home() {
  ...
  isMobileScreen ?
    image = `url(https://image.tmdb.org/t/p/original${highlightedMovie?.poster_path})`
    :
    image = `url(https://image.tmdb.org/t/p/original${highlightedMovie?.backdrop_path})`
